...
class Company:
    def __init__(self, invoice):
        ...
        # Tu propia empresa (comprador) va en AccountingCustomerParty
    ...
    def AdditionalAccountID(self, value):
        self.set_value({'cac': self.names['cac'], 'cbc': self.names['cbc']}, '//cac:AccountingCustomerParty/cbc:AdditionalAccountID', value)
    ...
    def PartyName(self, value):
        self.set_value({'cac': self.names['cac'], 'cbc': self.names['cbc']}, '//cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name', value)
